...
namespace EfCoreSample.Data.Migrations
{
    ...
    [Migration("20220506055420_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfCoreSample.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID");
            ...
            modelBuilder.Entity("EfCoreSample.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EfCoreSample.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EfCoreSample.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID");
            ...
            modelBuilder.Entity("EfCoreSample.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EfCoreSample.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("EfCoreSample.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.Models.CustomerAddress", b =>
                {
                    b.HasOne("EfCoreSample.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("EfCoreSample.Models.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("EfCoreSample.Models.Product", b =>
                {
                    b.HasOne("EfCoreSample.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("EfCoreSample.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("EfCoreSample.Models.ProductCategory", b =>
                {
                    b.HasOne("EfCoreSample.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("EfCoreSample.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("EfCoreSample.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("EfCoreSample.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("EfCoreSample.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("EfCoreSample.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("EfCoreSample.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("EfCoreSample.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("EfCoreSample.Models.Address", "ShipToAddress")
